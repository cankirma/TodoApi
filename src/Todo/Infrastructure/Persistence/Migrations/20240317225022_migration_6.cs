    ...
    public partial class migration_6 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Todos",
                columns: new[] { "Id", "Content", "CreateTime", "Status", "Title", "UpdatedDate" },
                values: new object[,]
                {
                    { new Guid("05dfb8a1-b918-4420-b70c-b68806bd6ebd"), "This is the first todo", new DateTime(2024, 3, 17, 22, 50, 22, 32, DateTimeKind.Utc).AddTicks(1038), 1, "First Todo", new DateTime(2024, 3, 17, 22, 50, 22, 32, DateTimeKind.Utc).AddTicks(1039) },
                    { new Guid("a3852b7e-1e9d-4e48-83dd-fd44af63629a"), "This is the second todo", new DateTime(2024, 3, 17, 22, 50, 22, 32, DateTimeKind.Utc).AddTicks(1041), 0, "Second Todo", new DateTime(2024, 3, 17, 22, 50, 22, 32, DateTimeKind.Utc).AddTicks(1041) }
                });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CreateTime", "Email", "FirstName", "LastName", "Password", "UpdatedDate" },
                values: new object[] { new Guid("2ac6ae43-86ec-40f4-a3cf-45e26d341ac1"), new DateTime(2024, 3, 17, 22, 50, 22, 32, DateTimeKind.Utc).AddTicks(1154), "user@example.com", "Can", "Doe", "D0B3749570B6AA9155E3CAF5E42D9AEFE826600AF86A80EE4051CE6F76FA5D0D:2A59480760E144B6C0BC4954D3C2B37B:50000:SHA256", new DateTime(2024, 3, 17, 22, 50, 22, 32, DateTimeKind.Utc).AddTicks(1154) });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Todos",
                keyColumn: "Id",
                keyValue: new Guid("05dfb8a1-b918-4420-b70c-b68806bd6ebd"));

            migrationBuilder.DeleteData(
                table: "Todos",
                keyColumn: "Id",
                keyValue: new Guid("a3852b7e-1e9d-4e48-83dd-fd44af63629a"));

            migrationBuilder.DeleteData(
                table: "Users",
                keyColumn: "Id",
                keyValue: new Guid("2ac6ae43-86ec-40f4-a3cf-45e26d341ac1"));
